        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                ...
                <div class="heading-properties clearfix sidebar-widget">
                    <div class="pull-left">
                    	<h3><span>방번호 : </span>${customerBoard.customerBoard_Seq}</h3>
                    	<h3><span>방태그 : </span>${customerBoard.customerBoard_Tag}</h3>
                    </div>
                    <div class="pull-left">
                    	<h3><span>방제목 : </span>${customerBoard.customerBoard_Title}</h3>
                    	<h3><span>작성자 : </span>${customerBoard.customer_ID}</h3>
                    </div>
                    <div class="pull-right">
                    	<h3><span>방 생성시간 : </span>${customerBoard.customerBoard_Indate}</h3>
                        <h3><span>조회수 : </span>${customerBoard.customerBoard_Hitcount}</h3>
                ...
                <div class="Properties-details-section sidebar-widget">
                    ...
                    <div class="properties-comments mb-40" id="replyContent">
                        ...
                        <div class="comments-section" >
							...
							<!-- cf:foreach 쓰는 부분 -->
							<c:forEach var="customerCommentList" items="${customerCommentList3}">
                                ...
                                <div class="row">
                                    <!-- <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group subject">
                                            <input type="text" name="customerComment_Title" id="customerComment_Title" class="input-text" placeholder="제목">
                                        </div>
                                    </div> -->
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group message">
                                            <textarea class="input-text" name="customerComment_Content" id="customerComment_Content" placeholder="Content"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
...
$("#submitReply").on("click",function(){
	...
	$.ajax({
		...
		url:"insertCustomerComment",
		data:{
			customerBoard_Seq:$(this).attr("data-val"),
			customerComment_Content:$("#customerComment_Content").val(),
