    ...
    <script>
    	...
    	function profilePasswordUpdate(){
    		$(".button-theme").on("click", function(){
    			var current = "${sessionScope.customer.customer_PW}";
    			var current2 = $("#currentPassword").val();
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-7">
                ...
                <div class="my-address">
                    ...
                    <form action="profilePasswordUpdate" method="post" id = "profilePasswordUpdate">
                        <div class="form-group">
                            <label>Current Password</label>
                            <input type="password" class="input-text" name="currentPassword" id = "currentPassword" placeholder="현재 비밀번호">
                        </div>
                        <div class="form-group">
                            <label>New Password</label>
                            <input type="password" class="input-text" name="customer_PW"  id = "customer_PW" placeholder="새로운 비밀번호">
                            <input type = "hidden" value = "${sessionScope.customer.customer_ID }" name = "customer_ID">
                        </div>
                        <div class="form-group">
                            <label>Confirm New Password</label>
                            <input type="password" class="input-text" name="confirmPassword" id = "confirmPassword" placeholder="새로운 비밀번호 한번 더 ">
                        </div>
