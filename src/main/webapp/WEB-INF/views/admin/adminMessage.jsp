                ...
                <div class="row clearfix">
                  <!--   <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6"> -->
                        <div class="panel panel-default">
                            <div class="panel-heading">Administrator Comment Message</div>
                       ...
                       <div class="row clearfix">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
	                                <div class="col-sm-10">
	                                    <input type="text" placeholder="Insert Content" class="form-control input-sm" name = "adminMessage_Content" id = "adminMessage_Content"/>
	                              	...
	                              	<div class="pull-left m-w-150">
	                              		  <button type="button" class="btn btn-block btn-default btn-sm" id = "adminMessageButton">Insert</button>
	                              	</div>  
                            </div>
                        </div>
                    </div>
