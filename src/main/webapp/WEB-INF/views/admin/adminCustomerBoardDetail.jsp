...
<body>
        ...
        <section class="content">
                ...
                <div class="row clearfix">
                   <!--  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6"> -->
                        <div class="panel panel-default">
                            <div class="panel-heading">[${adminCustomerDetail.customerBoard_Tag}] ${adminCustomerDetail.customerBoard_Title}</div>
                            <div class="panel-body">
                                <table class="table customerBoardDetail" data_seq="${adminCustomerDetail.customerBoard_Seq}">
                                    <tbody>
                                        <tr>
                                            <td width=15%;><b>작성자ID</b></td>
                                            <td>${adminCustomerDetail.customer_ID}</td>
                                        </tr>
                                        <tr>
                                            <td><b>등록일시</b></td>
                                            <td>${adminCustomerDetail.customerBoard_Indate}</td>
                                        </tr>
                                        <tr>
                                            <td><b>본문</b></td>
                                            <td>${adminCustomerDetail.customerBoard_Content}</td>
                                        </tr>
                                        <%-- <tr>
                                ...
                                <table>
                                	<tr>
                                		<td> <button type="button" class="btn btn-outline btn-default enterpriseBoardDelete" data_bSeq="${adminCustomerDetail.customerBoard_Seq}"><i class="fa fa-close"></i> Delete</button></td>
                                	</tr>
                                </table>
                            </div>
                        </div>
            ...
            <div class="row clearfix">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body customerBoardCommentList"></div>
                        </div>
              </div>
			<div class="row clearfix">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
	                                <div class="col-sm-10">
	                                    <input type="text" placeholder="내용을 써주세요.." class="form-control input-sm" name = "customerComment_Content" id = "customerComment_Content"/>
	                                    <input type = "hidden" value = "${adminCustomerDetail.customerBoard_Seq}" name = "customerBoard_Seq" id = "customerBoard_Seq">
	                                </div>   
	                              	<div class="pull-left m-w-150">
	                              		  <button type="button" class="btn btn-block btn-default btn-sm" id = "adminCustomerCommentButton">Insert</button>
	                              	</div>  
                            </div>
                        </div>
              </div>
    ...
    <!--개인 js -->
      ...
      <script src="resources/adminBoot/assets/js/customerBoardComment.js"></script>
</body>
</html>
