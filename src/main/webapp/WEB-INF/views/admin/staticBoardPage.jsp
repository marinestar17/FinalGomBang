...
<body>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                         <div class="panel panel-default">
                            <div class="panel-heading">Customer Age Static</div>
                    ...
                    <!-- Donut Chart -->
                      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                       	 <div class="panel panel-default">
                            <div class="panel-heading">Customer Gender Static</div>
                            <div class="panel-body">
    ...
    <script src="resources/adminBoot/assets/js/customerStats.js"></script>
