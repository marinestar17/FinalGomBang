...
<head>
	...
	function insertItem(){
		...
		var enterpriseBoard_Title = $("#enterpriseBoard_Title").val();
		var enterpriseBoard_Content = CKEDITOR.instances.editor.getData();
		var enterpriseBoard_Seq = $("#enterpriseBoard_Seq").val();
		var enterpriseBoard = {
		...
		console.log(enterpriseBoard);
		$.ajax({
				url:"remakeEnterpriseboard",
				type:"POST",
				data:enterpriseBoard,
				success:function(data){
					console.log("성공");
					if (data=="success") {
					location.href="enterpriseBoardlist";
    ...
    <div class="overlay">
        <div class="container">
            <div class="breadcrumb-area">
                <h1>EnterpriseBoard</h1>
                <ul class="breadcrumbs">
                    <li><a href="index.html">Home</a></li>
                    <li class="active">EnterpriseBoard</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="submit-address">
                    <form id="remakeEnterpriseboard" method="post">
                        ...
                        <div class="row">
                        	<div class="col-md-6 col-sm-6">
	                            <div class="form-group">
	                                <label>제목</label>
	                                <input type="text" class="input-text" id="enterpriseBoard_Title" name="enterpriseBoard_Title" value="${enterpriseBoard.enterpriseBoard_Title}" placeholder="Board Title">
	                            </div>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                           ...
                           <input type="hidden" id="enterpriseBoard_Seq" name="enterpriseBoard_Seq" value="${enterpriseBoard.enterpriseBoard_Seq}">
                        </div>
                        </div>
                    </form>
                </div>
