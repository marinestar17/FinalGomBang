                ...
                <div class="user-account-box">
                    ...
                    <div class="content">
                        <ul>
                            ...
                            <li>
                                <a href="reservationwait" class="active">
                ...
                <table class="manage-table responsive-table">
                    ...
                    <tr>
                        <td class="title-container">
                            <div class="title">
                                <h4><a href="#">${reservationlist.forSale_Title }</a></h4>
                                <span><i class="fa fa-map-marker"></i> ${reservationlist.geoapi_prefectures} ${reservationlist.geoapi_cities} ${reservationlist.geoapi_towns} ${reservationlist.geoapi_remain} </span>
                                <span class="table-property-price">${reservationlist.forSale_Rent }yen /${reservationlist.forSale_Status}</span>
                            </div>
                        </td>
                        <td class="expire-date hidden-xs">${reservationlist.customer_ID}</td>
                        <td class="action">
                            <a class="update" data_seq="${reservationlist.reservation_Seq }"><i class="glyphicon glyphicon-ok"></i></i> Confirm</a>
                        </td>
                    </tr>
                     </c:forEach>
                   <!--  <tr>
