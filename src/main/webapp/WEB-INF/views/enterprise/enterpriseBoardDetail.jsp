        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <ul class="top-social-media pull-right">
                    ...
                    <li>
                        <a href="goEnterprisePage" class="sign-in"><i class="fa fa-sign-in"></i> Login</a>
                    </li>
                    <li>
                        <a href="goSignup" class="sign-in"><i class="fa fa-user"></i> Register</a>
                    </li>
                    </c:if>
                    ...
                    <li>
                        <a href="goSignup" class="sign-in"><i class="fa fa-user"></i>Enterprise Modify</a>
                    </li>
                    </c:if>
                </ul>
            </div>
                                ...
                                <div class="row">
                                    <!-- <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group subject">
                                            <input type="text" name="enterpriseComment_Title" id="enterpriseComment_Title" class="input-text" placeholder="제목">
                                        </div>
                                    </div> -->
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="form-group send-btn mb-0">
                                            <button type="button" id="submitReply2" class="button-md button-theme" data-val="${enterpriseBoard.enterpriseBoard_Seq}">작성 완료</button>
