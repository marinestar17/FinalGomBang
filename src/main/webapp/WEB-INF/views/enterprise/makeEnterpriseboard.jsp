        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="submit-address">
                    <form id="insertEnterpriseitem" method="post">
                        ...
                        <div class="row">
                        	<div class="col-md-6 col-sm-6">
	                            <div class="form-group">
	                                <label>제목</label>
	                                <input type="text" class="input-text" id="enterpriseBoard_Title" name="enterpriseBoard_Title" placeholder="Board Title">
	                            </div>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                           <input type="hidden" id="enterprise_ID" name="enterprise_ID" value="${sessionScope.enterpriseLoginID}">
                           <input type="button" class="btn button-md button-theme" id="insertItem" value="등록">
                        </div>
                        </div>
                    </form>
                </div>
