            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="content">
                         <ul>
                            ...
                            <li>
                             ...
                             <li>
                                <a href="tradeCompleteList?enterprise_ID=${sessionScope.enterpriseLoginID}" class="active">
             ...
             <div class="col-lg-8 col-md-8 col-sm-12">
                ...
                <table class="manage-table responsive-table">
                    <tbody>
                      <c:forEach var="tradeList" items="${tradeList}" varStatus="status">
                    <tr>
                        <td class="title-container">
                            <div class="title">
                                <h4><a href="#">${tradeList.forSale_Title }</a></h4>
                                <span><i class="fa fa-map-marker"></i>${tradeList.geoapi_prefectures} ${tradeList.geoapi_cities} ${tradeList.geoapi_towns} ${tradeList.geoapi_remain} </span>
                                <span class="table-property-price">${tradeList.forSale_Rent}</span>
                            </div>
                        </td>
                        <td class="expire-date hidden-xs">${tradeList.customer_ID}</td>
                        <td class="action">
                        	Trade Complete.
                        </td>
                        <%-- <td class="action">
