...
public class Item {
	...
	private String forSale_SubwayDistance;
	...
	public Item(int forSale_Seq, String enterprise_ID, String geoapi_prefectures, String geoapi_cities,
			...
			double forSale_Lat, double forSale_Lng, String forSale_Subway, String forSale_SubwayDistance,
			int forSale_HitCount, String searchSelect, String search, int stats_Count, String forSale_Trade) {
		super();
	...
	public String getForSale_SubwayDistance() {
		return forSale_SubwayDistance;
	}

	public void setForSale_SubwayDistance(String forSale_SubwayDistance) {
		this.forSale_SubwayDistance = forSale_SubwayDistance;
	}
	...
	public String toString() {
		return "Item [forSale_Seq=" + forSale_Seq + ", enterprise_ID=" + enterprise_ID + ", geoapi_prefectures="
				...
				+ ", forSale_SubwayDistance=" + forSale_SubwayDistance + ", forSale_HitCount=" + forSale_HitCount
				+ ", searchSelect=" + searchSelect + ", search=" + search + ", stats_Count=" + stats_Count
				+ ", forSale_Trade=" + forSale_Trade + "]";
	}
