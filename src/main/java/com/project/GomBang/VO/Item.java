...
public class Item {
	...
	public Item(int forSale_Seq, String enterprise_ID, String geoapi_prefectures, String geoapi_cities,
			...
			String forSale_Trade, String forSale_TradeIndate, String forSale_TradeCustomer) {
		super();
	...
	public String toString() {
		return "Item [forSale_Seq=" + forSale_Seq + ", enterprise_ID=" + enterprise_ID + ", geoapi_prefectures="
				...
				+ ", forSale_TradeIndate=" + forSale_TradeIndate + ", forSale_TradeCustomer=" + forSale_TradeCustomer
				+ "]";
	}
