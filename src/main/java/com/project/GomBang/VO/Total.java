...
public class Total {
	...
	private String forSale_TradeIndate;
	private int stats_Count;
	private String search;
	private String searchSelect;
	private String forSale_TradeCustomer;
	public Total(int image_Seq, int forSale_Seq, String customer_ID, String customer_Email, String originName,
			...
			String forSale_Trade, String forSale_TradeIndate, int stats_Count, String search, String searchSelect,
			String forSale_TradeCustomer) {
		super();
		...
		this.forSale_TradeIndate = forSale_TradeIndate;
		this.stats_Count = stats_Count;
		this.search = search;
		this.searchSelect = searchSelect;
		this.forSale_TradeCustomer = forSale_TradeCustomer;
	}
	public Total() {
		super();
	}
	...
	public String getForSale_TradeIndate() {
		return forSale_TradeIndate;
	}
	public void setForSale_TradeIndate(String forSale_TradeIndate) {
		this.forSale_TradeIndate = forSale_TradeIndate;
	}
	...
	public String getForSale_TradeCustomer() {
		return forSale_TradeCustomer;
	}
	public void setForSale_TradeCustomer(String forSale_TradeCustomer) {
		this.forSale_TradeCustomer = forSale_TradeCustomer;
	}
	@Override
	public String toString() {
		return "Total [image_Seq=" + image_Seq + ", forSale_Seq=" + forSale_Seq + ", customer_ID=" + customer_ID
				...
				+ forSale_Lat + ", forSale_Lng=" + forSale_Lng + ", forSale_Trade=" + forSale_Trade
				+ ", forSale_TradeIndate=" + forSale_TradeIndate + ", stats_Count=" + stats_Count + ", search=" + search
				+ ", searchSelect=" + searchSelect + ", forSale_TradeCustomer=" + forSale_TradeCustomer + "]";
	}
