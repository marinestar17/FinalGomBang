...
public class SearchItem {
	...
	public SearchItem(String forSale_Status, String forSale_HouseType, String geoapi_prefectures, String geoapi_cities,
			String geoapi_towns, int min_price, int max_price, String forSale_OptionA, String forSale_OptionB,
			String forSale_OptionC, String forSale_OptionD, String forSale_OptionE, String forSale_OptionF) {
		super();
	...
	public String toString() {
		return "SearchItem [forSale_Status=" + forSale_Status + ", forSale_HouseType=" + forSale_HouseType
				...
				+ geoapi_towns + ", min_price=" + min_price + ", max_price=" + max_price + ", forSale_OptionA="
